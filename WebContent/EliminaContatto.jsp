...
if(list == null){
	...
	htmlCode += "<form action=\"./Elimina.jsp\" method=\"post\">ID DA ELIMINARE&nbsp;<input type=\"text\" name=\"id\" value=\"\" placeholder=\"ID da eliminare\"/><br/><input type=\"submit\" value=\"ELIMINA\"/></form>";
}
%>
