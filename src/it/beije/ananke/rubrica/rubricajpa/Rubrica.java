		...
		do {
			...
			case 1:
				...
				do {
					...
					contacts = JPAManager.selectByField(field, firstName.toString());
			...
			case 2:
				...
				do {
					...
					contacts = JPAManager.selectByField(field, lastName.toString());
					System.out.println("Found? [yes/no]");
					if (scanner.nextLine().equalsIgnoreCase("yes")) {
						found2 = true;
					} else {
			...
			case 3:
				...
				do {
					...
					contacts = JPAManager.selectByField(field, phoneNumber.toString());
					System.out.println("Found? [yes/no]");
					if (scanner.nextLine().equalsIgnoreCase("yes")) {
						found3 = true;
					} else {
			...
			case 4:
				...
				do {
					...
					contacts = JPAManager.selectByField(field, email.toString());
					System.out.println("Found? [yes/no]");
					if (scanner.nextLine().equalsIgnoreCase("yes")) {
						found4 = true;
					} else {
